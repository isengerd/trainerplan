...
type InvitationInfo = { email: string; name: string; role: "admin" | "trainer" | "player"; group?: string; team?: string; club?: string; expiresAt: string };
