...
export function TrainerApp() {
  ...
  const overview = (
    <section className="overview-page">
      ...
      <div className={`overview-next-grid ${nextTournament ? "with-tournament" : ""}`}>
