...
const importedExercises: Exercise[] = [
  { id: "zwei-gegen-zwei-torhueter-chaos", title: "2 gegen 2 + Torhüter gegen das Chaos", description: "Zwei feste Zonen schaffen freie Räume: Erst der Pass zum Partner, dann darf das direkte Duell und der Torabschluss folgen.", duration: 16, players: "6", ageGroup: "F-Jugend", ageRange: "U8/U9", category: "Hauptteil", accent: "#f5c451", intensity: "Hoch", focus: ["Freilaufen", "Passspiel", "Spielintelligenz", "Torschuss"], setup: "Ein etwa 20 × 16 m großes Feld mit zwei Jugendtoren und Torhütern aufbauen. Eine Hütchenlinie teilt das Feld längs in Zone A und Zone B. In jeder Zone spielt je ein Angreifer gegen einen Verteidiger; kein Feldspieler verlässt seine Zone. Der Torhüter eröffnet zu einem Angreifer. Vor dem Abschluss muss der Ball einmal in die andere Zone gespielt werden. Dort entsteht das 1 gegen 1 zum Tor.", coaching: ["Mach dich groß – such das freie Fenster", "Erst in die andere Zone passen, dann mutig ins 1 gegen 1", "Torhüter eröffnen schnell und flach", "Kurz erklären, viel spielen und Rollen regelmäßig wechseln"], variations: ["Getrennt: Die Spieler bleiben links und rechts in ihren Zonen", "Reihen: Hintere Spieler bleiben in der Abwehrzone, vordere Spieler in der Angriffszone", "Nach einigen Runden die Zonengrenze entfernen und beobachten, ob die Breite erhalten bleibt"], materials: [{ id: "balls", count: 6 }, { id: "cones", count: 10 }, { id: "youthGoals", count: 2 }, { id: "bibs", count: 4 }], fieldSize: "ca. 20 × 16 m", variant: 32 },
